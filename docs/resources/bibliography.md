...
10. **Chazal, F. & Michel, B. (2021)**. "An Introduction to Topological Data Analysis:
    Fundamental and Practical Aspects for Data Scientists."
    *Frontiers in Artificial Intelligence*, 4.
    - Modern, practical introduction to TDA
    - Excellent for ML practitioners
    - [arXiv:1710.04019](https://arxiv.org/abs/1710.04019)

11. **Edelsbrunner, H. & Harer, J. (2010)**. *Computational Topology: An Introduction*.
    American Mathematical Society.
    - Comprehensive algorithms for computing homology
    - Source for Betti number computation
    - [AMS Bookstore](https://bookstore.ams.org/mbk-69)

### Category Theory Background

12. **Mac Lane, S. & Moerdijk, I. (1994)**. *Sheaves in Geometry and Logic*.
    Springer.
...
13. **Fong, B. & Spivak, D. (2019)**. *An Invitation to Applied Category Theory*.
...
|---------|----------------|----------------------|
| Sheaf definition | Mac Lane & Moerdijk [12] | `theory/02_sheaves_intuition` |
...
| Cohomology | Ghrist [15] | `theory/04_gluing_and_cohomology` |
| Sensor fusion | Robinson [2] | `examples/04_gluing.py` |
| Topological loss | Carlsson [8], Chazal [10] | `theory/06_topological_loss` |
| Betti numbers | Edelsbrunner [11] | `measured_transforms.py` |
