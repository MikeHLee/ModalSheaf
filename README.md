...
### Getting Started
- [Intuitive Guide to Cohomology](docs/INTUITIVE_COHOMOLOGY.md) — No math background required!
- [Examples](examples/) — Practical code examples

### Theory Deep Dives
- [Why Topology?](docs/theory/00_why_topology.md) — Motivation
- [Sheaves Intuition](docs/theory/02_sheaves_intuition.md) — The key abstraction
- [Advanced Cohomology](docs/theory/05_advanced_cohomology.md) — Rigorous computation
- [Cocycles in Practice](docs/theory/06_cocycles_in_practice.md) — Real-world examples
- [Persistence Guide](docs/theory/07_persistence_guide.md) — Handling noisy data
